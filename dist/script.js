...
/* harmony import */ var _modules_officer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/officer */ "./src/js/modules/officer.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  feedSlider.init();
  new _modules_officer__WEBPACK_IMPORTED_MODULE_3__["default"]({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Officer; });
...
/*#__PURE__*/
function () {
  function PlayVideo(trigers, overlay) {
  ...
  _createClass(PlayVideo, [{
    ...
    value: function bindClose() {
      ...
      this.close.forEach(function (clos) {
...
function (_Slider) {
  ...
  function MainSlider(btn, activeClass) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btn, activeClass));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlide(n) {
      ...
      try {
        if (n == 3) {
          setTimeout(function () {
            _this.popupBlock.style.opacity = '1';

            _this.popupBlock.classList.add('animated', 'fadeInUp');
          }, 3000);
        } else {
...
function (_Slider) {
  ...
  function MiniSlider(prev, next, container, animated) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, prev, next, container, animated));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    key: "unlockTimerByMouse",
    value: function unlockTimerByMouse() {
      var _this2 = this;
    ...
    key: "deliteBtnFromSlides",
    value: function deliteBtnFromSlides() {
      var arr = [];
      this.slides.forEach(function (slide) {
